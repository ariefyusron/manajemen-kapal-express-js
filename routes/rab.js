...
router.post('/:idKapal/pekerjaan/:idKapal', middleware.checkAuth, controller.createPekerjaan);
router.patch('/:idKapal/pekerjaan/:idKapal/:id', middleware.checkAuth, controller.updatePekerjaan);
router.delete('/:idKapal/pekerjaan/:idKapal/:id', middleware.checkAuth, controller.deletePekerjaan);
router.get('/:idKapal/pekerjaan/:idKapal', middleware.checkAuth, controller.getPekerjaan);
